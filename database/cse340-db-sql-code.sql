-- =========================================
-- 1. Drop objects if they exist (rebuild prep)
-- =========================================
...
ALTER TYPE public.account_type OWNER TO eli62632;
-- =========================================
-- 3. Create tables
-- =========================================
...
CREATE TABLE public.review (
    ...
    review_screen_name VARCHAR NOT NULL,
...
ADD CONSTRAINT fk_reviews_inventory FOREIGN KEY (inv_id) REFERENCES public.inventory (inv_id) ON DELETE CASCADE;
ALTER TABLE public.review
ADD CONSTRAINT fk_reviews_account FOREIGN KEY (account_id) REFERENCES public.account (account_id) ON DELETE CASCADE;
-- =========================================
-- Index for sorting reviews by newest per vehicle
-- =========================================
CREATE INDEX idx_reviews_inv_date ON public.review (inv_id, review_date DESC);
-- =========================================
-- 5. Seed initial data
-- =========================================
...
VALUES (
    ...
    (
        ...
        'Wrangler',
        '2019',
        'The Jeep Wrangler is small and compact with enough power to get you where you want to go. It''s great for everyday driving as well as offroading whether that be on the rocks or in the mud!',
        '/images/wrangler.jpg',
...
-- =========================================
-- 6. Update GM Hummer description
-- =========================================
...
WHERE inv_id = 10;
-- =========================================
-- 7. Update all image and thumbnail paths
-- =========================================
UPDATE public.inventory
